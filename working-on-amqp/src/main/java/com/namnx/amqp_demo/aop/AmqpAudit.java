package com.namnx.amqp_demo.aop;
...
public class AmqpAudit {
	...
	@Pointcut("execution(* com.namnx.amqp_demo.amqp.*.*(..)) || execution(* com.namnx.amqp_demo.amqp.*.*.*(..))")
	public void logAMQP() {}
	...
	@Before("execution(* com.namnx.amqp_demo.listener.*.*(..))")
